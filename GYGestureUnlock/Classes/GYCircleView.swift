...
public enum CircleViewType: Int {
    /// 设置手势密码
...
public protocol GYCircleViewDelegate {
...
public class GYCircleView: UIView {
    
    /// 是否裁剪
    public var clip: Bool = true
    
    /// 是否有箭头
    public var _arrow: Bool?
    ...
    /// 解锁类型
    public var type: CircleViewType?
    
    public var delegate: GYCircleViewDelegate?
    
    /// 选中圆的集合
    public var circleSet: NSMutableArray?
    
    /// 当前点
    public var currentPoint: CGPoint?
    
    /// 数组清空标志
    public var hasClean: Bool?
    ...
    public init(frame: CGRect,type: CircleViewType,clip: Bool,arrow: Bool) {
